...
<main>
	...
	<	<section class="bg-sec2 l-pt">
		<div class="container">
				...
				<div class="card rounded-top">
					<div class="row d-flex justify-content-center align-items-center">
						<div class="col-11">
							...
							<div class="row">
								<div class="col-6 col-md-3 col-lg-3">
									<p><b>Nome da empresaa:</b><br>
									<span class="partnerData" id="NomEmp">Supertecnologia</span></p>
								</div>
								<div class="col-6 col-md-3 col-lg-3">
									<p><b>Categoría:</b><br>
									<span class="partnerData" id="CatEmp">Revendedor / Commercial</span></p>
								</div>
								<div class="col-6 col-md-3 col-lg-3">
				...
				<div class="info-partner">
					<div class="alert alert-success">As informações foram atualizadas com sucesso.</div>
					<div class="card bg-success">
						<div class="row d-flex justify-content-center align-items-center">
							<div class="col-11">
								<div class="row">
					...
					<div class="card bg-success rounded-bottom">
						<div class="row d-flex justify-content-center align-items-center">
							<div class="col-11">
								<div class="row">
									<div class="col-6 col-md-8 col-lg-10">
										<h3>Detalhes do contato secundário da empresa</h3>
									</div>
									<div class="col-6 col-md-4 col-lg-2">
										<a href="cp-partner-edit.php" class="lebtn btn-ghost w-100">Editar</a>
									</div>
