					...
					<div class="row d-flex justify-content-center align-items-center">
						<div class="col-11">
							...
							<div class="row">
								...
								<div class="col-6 col-md-3 col-lg-3">
									<p><b>Categoria:</b><br>
									<span class="partnerData" id="CatEmp">Revendedor / Comercial</span></p>
								</div>
								<div class="col-6 col-md-3 col-lg-3">
							...
							<div class="col-11">
								...
								<div class="row">
									<div class="col-4 col-md-3 col-lg-3">
										...
										<span class="partnerData" id="CatPartner">Revendedor Comercial</span></p>
									</div>
									<div class="col-4 col-md-3 col-lg-3">
								...
								<div class="row">
									...
									<table class="valuation-table td-3 d-block d-md-none d-lg-none">
										...
										<tr>
											<td clasS="valuation-head" bgcolor="#000000">Pontos de vendas por trimestre</td>
											<td align="center">5,000</td>
										</tr>
										<tr>
											<td clasS="valuation-head" bgcolor="#000000">Fornecedores que completam missões de área por trimestre</td>
											<td align="center">2</td>
										</tr>
									</table>
								</div>
