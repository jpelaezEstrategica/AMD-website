...
<main>
	...
	<section class="bg-sec2">
		<div class="container">
				...
				<div class="card rounded l-pt">					<div class="row d-flex justify-content-center align-items-center">
						<div class="col-11">
							<div class="row">
								<div class="col-6 col-md-8 col-lg-10">
					...
					<div class="row d-flex justify-content-center align-items-center">
						<div class="col-11">
							...
							<div class="row">
								...
								<div class="col-12 col-md-3 col-lg-3">
									<p><b>Categoría:</b><br>
									<span class="parnerData" id="CatEmp">Revendedor/Components</span></p>
								</div>
								<div class="col-12 col-md-3 col-lg-3">
									<p><b>Status:</b> <br>
									<span class="parnerData" id="EdoEmp">Activo</span></p>
				...
				<div class="card rounded l-pt">					<div class="row d-flex justify-content-center align-items-center">
						<div class="col-11">
							...
							<div class="row">
								...
								<div class="col-12 col-md-3 col-lg-3">
									<p><b>Categoría:</b><br>
									<span class="parnerData" id="CatEmp">Revendedor/Commercial</span></p>
								</div>
								<div class="col-12 col-md-3 col-lg-3">
									<p><b>Status:</b> <br>
									<span class="parnerData" id="EdoEmp">Activo</span></p>
				...
				<div class="spacer-pm"></div>
				<!-- CARD [↓] ------------------------ -->
				<div class="card rounded pLocked l-esp">
					<div class="row d-flex justify-content-center align-items-center">
						<div class="col-11">
							<div class="row">
								<div class="col-6 col-md-8 col-lg-10">
				...
				<div class="card rounded pLocked l-pt">					<div class="row d-flex justify-content-center align-items-center">
						<div class="col-11">
							<div class="row">
								<div class="col-6 col-md-8 col-lg-10">
									<h3>Perfil do parceiro</h3>
